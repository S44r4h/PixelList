    ...
    return (
      ...
      {/* Form component */}
        <fieldset className="fieldset w-full max-w-md bg-base-200 border border-base-300 p-6 rounded-box">
          ...
          <input name="name"  type="text" className="input w-full" placeholder="Name" required="required" onChange={(e) => SetRegisterform({...registerform, name: e.target.value})} />

          <label className="fieldset-label">Email</label>
          <input name="email" type="email" className="input w-full" placeholder="Email" required="required" onChange={(e) => SetRegisterform({...registerform, email: e.target.value})} />
